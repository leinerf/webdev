...
function sumEvenArguments(){
    ...
    return newArgs.filter(function(value){
        return value%2 === 0;
...
function bind(fn, thisArg){
    ...
    var myThis = arguments[1];
    var passingArgs = Array.prototype.slice.call(arguments,2);
    return function(){
        var thisArgs = Array.prototype.slice.call(arguments);
        var allArgs = passingArgs.concat(thisArgs);
        console.log(allArgs)
...
function flip(fn, thisArg){
    ...
    return function(){
        var thisArgs = Array.prototype.slice.call(arguments);
        var allArgs = passingArgs.concat(thisArgs).slice(0,fn.length);
        console.log(allArgs)
...
//fn.length returns  number of parameters accepted